...
export default class SECBOTLChecksCase extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    setEvidenceNeeded = (e) => {
        ...
        if (isEvidenceNeeded) {
            ...
            resetFields(["SECBOTLChecksCaseNeedCaseExplain"]);
        }
    }
            ...
            show ?
                <Fragment>
                    <Ones_Row col={{ lg: 24 }} className={styles.marginTop} wrapItem>
                        {getFieldDecorator("secBOTLChecksCaseStatus", {
                            rules: formItemRules,
                            hidden: disabled,
                    ...
                    <Ones_Row col={{ lg: 24 }} wrapItem>
                        {getFieldDecorator("SECBOTLChecksCaseNeedCaseExplain", {
                            rules: rulesState,
                            hidden: disabled
                        })(
