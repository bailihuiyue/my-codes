...
export default class AFBOChecksCase extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    setEvidenceNeeded = (e) => {
        ...
        if (isEvidenceNeeded) {
            ...
            resetFields(["AFBOChecksCaseNeedCaseExplain"]);
        }
    }
            ...
            show ?
                <Fragment>
                    <Ones_Row col={{ lg: 24 }} wrapItem className={styles.marginTop}>
                        {getFieldDecorator("AFBOChecksCaseStatus", {
                            rules: formItemRules,
                            hidden: disabled,
                    ...
                    <Ones_Row col={{ lg: 24 }} wrapItem>
                        {getFieldDecorator("AFBOChecksCaseNeedCaseExplain", {
                            rules: rulesState,
                            hidden: disabled
                        })(
